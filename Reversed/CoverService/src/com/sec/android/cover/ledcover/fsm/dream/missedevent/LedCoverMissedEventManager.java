...
public class LedCoverMissedEventManager {
    ...
    public void removeAllMissedEvents() {
        this.mAllEventQueue.clear();
    ...
    public void addLatestEventsToCurrentQueue() {
        ...
        Log.d(TAG, "addLatestEventsToCurrentQueue: mCurrentEventQueue=" + String.valueOf(this.mCurrentEventQueue) + " mAllEventQueue=" + String.valueOf(this.mAllEventQueue));
    }
