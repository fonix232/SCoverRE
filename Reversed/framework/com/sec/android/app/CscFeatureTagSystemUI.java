...
public class CscFeatureTagSystemUI {
    ...
    public static final String TAG_CSCFEATURE_SYSTEMUI_CONFIGDISPLAYPOLICYFORLOCATIONINDICATOR = "CscFeature_SystemUI_ConfigDisplayPolicyForLocationIndicator";
    ...
    public static final String TAG_CSCFEATURE_SYSTEMUI_CONFIGINDICATORSTYLEFORBATTLEVEL = "CscFeature_SystemUI_ConfigIndicatorStyleForBattLevel";
    public static final String TAG_CSCFEATURE_SYSTEMUI_CONFIGMAXRSSILEVEL = "CscFeature_SystemUI_ConfigMaxRssiLevel";
    public static final String TAG_CSCFEATURE_SYSTEMUI_CONFIGMAXSTATUSFORNFC = "CscFeature_SystemUI_ConfigMaxStatusForNfc";
    public static final String TAG_CSCFEATURE_SYSTEMUI_CONFIGOPBRANDINGFORDATAINDICATOR = "CscFeature_SystemUI_ConfigOpBrandingForDataIndicator";
    ...
    public static final String TAG_CSCFEATURE_SYSTEMUI_CONFIGPOLICYFORMOBILEDATASETTING = "CscFeature_SystemUI_ConfigPolicyForMobileDataSetting";
    ...
    public static final String TAG_CSCFEATURE_SYSTEMUI_SUPPORTTODDLERMODE = "CscFeature_SystemUI_SupportToddlerMode";
}
