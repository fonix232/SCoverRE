    ...
    public static abstract class Stub extends Binder implements IEmergencyManager {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 3:
                    parcel.enforceInterface(DESCRIPTOR);
                    isEmergencyMode = checkValidPackage(parcel.readString(), parcel.readString(), parcel.readInt());
                    parcel2.writeNoException();
                    if (isEmergencyMode) {
                        i3 = 1;
                    }
                ...
                case 4:
                    parcel.enforceInterface(DESCRIPTOR);
                    isEmergencyMode = checkValidIntentAction(parcel.readString(), parcel.readString());
                    parcel2.writeNoException();
                    if (isEmergencyMode) {
                        i3 = 1;
                    }
                ...
                case 5:
                    parcel.enforceInterface(DESCRIPTOR);
                    isEmergencyMode = checkInvalidProcess(parcel.readString());
                    parcel2.writeNoException();
                    if (isEmergencyMode) {
                        i3 = 1;
                    }
                ...
                case 6:
                    parcel.enforceInterface(DESCRIPTOR);
                    isEmergencyMode = checkInvalidBroadcast(parcel.readString(), parcel.readString());
                    parcel2.writeNoException();
                    if (isEmergencyMode) {
                        i3 = 1;
                    }
                ...
                case 7:
                    parcel.enforceInterface(DESCRIPTOR);
                    isEmergencyMode = needMobileDataBlock();
                    parcel2.writeNoException();
                    if (isEmergencyMode) {
                        i3 = 1;
                    }
                ...
                case 10:
                    parcel.enforceInterface(DESCRIPTOR);
                    isEmergencyMode = isUserPackageBlocked();
                    parcel2.writeNoException();
                    if (isEmergencyMode) {
                        i3 = 1;
                    }
                ...
                case 13:
                    parcel.enforceInterface(DESCRIPTOR);
                    isEmergencyMode = addAppToLauncher(parcel.readString(), parcel.readInt() != 0);
                    parcel2.writeNoException();
                    if (isEmergencyMode) {
                        i3 = 1;
                    }
                ...
                case 14:
                    parcel.enforceInterface(DESCRIPTOR);
                    isEmergencyMode = checkModeType(parcel.readInt());
                    parcel2.writeNoException();
                    if (isEmergencyMode) {
                        i3 = 1;
                    }
