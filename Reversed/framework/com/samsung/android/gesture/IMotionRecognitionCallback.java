...
public interface IMotionRecognitionCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMotionRecognitionCallback {
        private static final String DESCRIPTOR = "com.samsung.android.gesture.IMotionRecognitionCallback";
        ...
        private static class Proxy implements IMotionRecognitionCallback {
            ...
            public void motionCallback(SemMotionRecognitionEvent semMotionRecognitionEvent) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (semMotionRecognitionEvent != null) {
                        obtain.writeInt(1);
                        semMotionRecognitionEvent.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
        ...
        public static IMotionRecognitionCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMotionRecognitionCallback)) ? new Proxy(iBinder) : (IMotionRecognitionCallback) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    motionCallback(parcel.readInt() != 0 ? (SemMotionRecognitionEvent) SemMotionRecognitionEvent.CREATOR.createFromParcel(parcel) : null);
                ...
                case 3:
                    parcel.enforceInterface(DESCRIPTOR);
                    listenerInfo = getListenerPackageName();
                    parcel2.writeNoException();
                    parcel2.writeString(listenerInfo);
                    return true;
                case 1598968902:
