...
public interface IKerykeionCallBack extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IKerykeionCallBack {
        private static final String DESCRIPTOR = "com.samsung.android.infoextraction.IKerykeionCallBack";
        ...
        public static IKerykeionCallBack asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IKerykeionCallBack)) ? new Proxy(iBinder) : (IKerykeionCallBack) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    onCompleted(parcel.createTypedArrayList(SemExtractedInfo.CREATOR));
