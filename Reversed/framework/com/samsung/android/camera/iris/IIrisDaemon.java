...
public interface IIrisDaemon extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IIrisDaemon {
        private static final String DESCRIPTOR = "com.samsung.android.camera.iris.IIrisDaemon";
        ...
        private static class Proxy implements IIrisDaemon {
            ...
            public void init(IIrisDaemonCallback iIrisDaemonCallback) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (iIrisDaemonCallback != null) {
                        iBinder = iIrisDaemonCallback.asBinder();
                    }
        ...
        public static IIrisDaemon asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IIrisDaemon)) ? new Proxy(iBinder) : (IIrisDaemon) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    authenticate = authenticate(parcel.readLong(), parcel.readInt(), parcel.createByteArray());
                ...
                case 11:
                    parcel.enforceInterface(DESCRIPTOR);
                    init(com.samsung.android.camera.iris.IIrisDaemonCallback.Stub.asInterface(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 12:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    parcel.enforceInterface(DESCRIPTOR);
                    processIRImage(parcel.readInt() != 0 ? (ParcelFileDescriptor) ParcelFileDescriptor.CREATOR.createFromParcel(parcel) : null, parcel.readInt(), parcel.readInt(), parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 15:
                    parcel.enforceInterface(DESCRIPTOR);
                    sendIRProperty(parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 16:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 18:
                    parcel.enforceInterface(DESCRIPTOR);
                    processFrontImage(parcel.readInt() != 0 ? (ParcelFileDescriptor) ParcelFileDescriptor.CREATOR.createFromParcel(parcel) : null, parcel.readInt(), parcel.readInt(), parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
