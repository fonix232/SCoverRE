...
public interface IIrisServiceLockoutResetCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IIrisServiceLockoutResetCallback {
        private static final String DESCRIPTOR = "com.samsung.android.camera.iris.IIrisServiceLockoutResetCallback";
        ...
        public static IIrisServiceLockoutResetCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IIrisServiceLockoutResetCallback)) ? new Proxy(iBinder) : (IIrisServiceLockoutResetCallback) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    onLockoutReset(parcel.readLong());
