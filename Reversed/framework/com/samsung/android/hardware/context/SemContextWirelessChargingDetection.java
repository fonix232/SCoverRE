...
public class SemContextWirelessChargingDetection extends SemContextEventContext {
    public static final Creator<SemContextWirelessChargingDetection> CREATOR = new C01951();
    public static final int MOVE = 1;
    public static final int NOMOVE = 0;
    private Bundle mContext;

    static class C01951 implements Creator<SemContextWirelessChargingDetection> {
        C01951() {
        }
