...
public interface ISemContextCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISemContextCallback {
        private static final String DESCRIPTOR = "com.samsung.android.hardware.context.ISemContextCallback";
            ...
            public void semContextCallback(SemContextEvent semContextEvent) throws RemoteException {
                ...
                try {
                    ...
                    if (semContextEvent != null) {
                        obtain.writeInt(1);
                        semContextEvent.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
        ...
        public static ISemContextCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ISemContextCallback)) ? new Proxy(iBinder) : (ISemContextCallback) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    semContextCallback(parcel.readInt() != 0 ? (SemContextEvent) SemContextEvent.CREATOR.createFromParcel(parcel) : null);
