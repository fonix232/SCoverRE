...
public class SemContextSLocationCoreAttribute extends SemContextAttribute {
    public static final Creator<SemContextSLocationCoreAttribute> CREATOR = new C01811();
    private static final String TAG = "SemContextSLocationCoreAttribute";
    ...
    static class C01811 implements Creator<SemContextSLocationCoreAttribute> {
        C01811() {
        }

        public SemContextSLocationCoreAttribute createFromParcel(Parcel parcel) {
            return new SemContextSLocationCoreAttribute(parcel);
        }

        public SemContextSLocationCoreAttribute[] newArray(int i) {
    ...
    private static class FusedBatchOption {
        ...
        boolean isValid() {
            if (this.period < 0) {
                Log.d(SemContextSLocationCoreAttribute.TAG, "FusedBatchOption.period is wrong.");
                return false;
            } else if (this.user_info < 0) {
                Log.d(SemContextSLocationCoreAttribute.TAG, "FusedBatchOption.user_info is wrong.");
                return false;
            } else if (this.flags < 0) {
                Log.d(SemContextSLocationCoreAttribute.TAG, "FusedBatchOption.flags is wrong.");
                return false;
            } else if (this.max_power < 0.0d) {
                Log.d(SemContextSLocationCoreAttribute.TAG, "FusedBatchOption.max_power is wrong.");
                return false;
            } else if (this.distance_thrs >= 0.0f) {
                return true;
            } else {
                Log.d(SemContextSLocationCoreAttribute.TAG, "FusedBatchOption.distance_thrs is wrong.");
                return false;
            }
        }
    }

    SemContextSLocationCoreAttribute() {
        this.mMode = -1;
        this.mAction = -1;
        this.mFenceId = 0;
        this.mRadius = 0;
    ...
    public SemContextSLocationCoreAttribute(int i, int i2) {
        this.mMode = -1;
        this.mAction = -1;
        this.mFenceId = 0;
        this.mRadius = 0;
    ...
    public SemContextSLocationCoreAttribute(int i, int i2, double d, double d2, int i3, long j) {
        this.mMode = -1;
        this.mAction = -1;
        this.mFenceId = 0;
        this.mRadius = 0;
    ...
    public SemContextSLocationCoreAttribute(int i, int i2, int i3) {
        this.mMode = -1;
        this.mAction = -1;
        this.mFenceId = 0;
        this.mRadius = 0;
    ...
    public SemContextSLocationCoreAttribute(int i, int i2, int i3, double d, double d2, int i4, int i5, int i6) {
        this.mMode = -1;
        this.mAction = -1;
        this.mFenceId = 0;
        this.mRadius = 0;
    ...
    public SemContextSLocationCoreAttribute(int i, int i2, int i3, int i4) {
        this.mMode = -1;
        this.mAction = -1;
        this.mFenceId = 0;
        this.mRadius = 0;
    ...
    public SemContextSLocationCoreAttribute(int i, int i2, int i3, int i4, int i5) {
        this.mMode = -1;
        this.mAction = -1;
        this.mFenceId = 0;
        this.mRadius = 0;
    ...
    public SemContextSLocationCoreAttribute(int i, int i2, int i3, long j, int i4, int i5, double d, float f) {
        this.mMode = -1;
        this.mAction = -1;
        this.mFenceId = 0;
        this.mRadius = 0;
    ...
    public SemContextSLocationCoreAttribute(int i, int i2, Location location) {
        this.mMode = -1;
        this.mAction = -1;
        this.mFenceId = 0;
        this.mRadius = 0;
