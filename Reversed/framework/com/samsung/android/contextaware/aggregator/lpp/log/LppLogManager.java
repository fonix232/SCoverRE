...
public class LppLogManager {
    ...
    private void LogAPDRLM(int i) {
        this.mAPDRLM_Logging.addLogStream(System.nanoTime() + "\t" + i + this.strFromAPDR + this.strFromLocM + "\n");
    }
    ...
    public void AddRTCoordinate(Location location) {
    }
    ...
    public void init(LppConfig lppConfig) {
    }

    public void setILppDataProviderListener(ILppDataProvider iLppDataProvider) {
        this.mLppDataProviderLnr = iLppDataProvider;
    }
