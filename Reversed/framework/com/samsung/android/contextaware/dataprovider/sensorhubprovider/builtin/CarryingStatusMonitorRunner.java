...
public class CarryingStatusMonitorRunner extends LibTypeProvider {
    public CarryingStatusMonitorRunner(int i, Context context, ISensorHubResetObservable iSensorHubResetObservable) {
    ...
    public int parse(byte[] bArr, int i) {
        ...
        i2 = i3 + 1;
        super.getContextBean().putContext(contextValueNames[1], (short) bArr[i3]);
