...
public class SensorHubParserProtocol {
    ...
    public enum ACTIVITY_TRACKER_EXT_LIB_TYPE {
        ...
        private ACTIVITY_TRACKER_EXT_LIB_TYPE(byte b) {
            this.value = b;
        }
    }
    ...
    public enum DATA_TYPE {
        ...
        LIBRARY_DATATYPE_ACTIVITY_CALIBRATION(ISensorHubCmdProtocol.TYPE_ACTIVITY_CALIBRATION_SERVICE),
        LIBRARY_DATATYPE_CH_LOC_TRIGGER(ISensorHubCmdProtocol.TYPE_CH_LOC_TRIGGER),
        LIBRARY_DATATYPE_FREE_FALL_DETECTION(ISensorHubCmdProtocol.TYPE_FREE_FALL_DETECTION),
        ...
        private DATA_TYPE(byte b) {
            this.value = b;
        }

        public static final String getCode(byte b) {
    ...
    public enum PEDOMETER_EXT_LIB_TYPE {
        ...
        private PEDOMETER_EXT_LIB_TYPE(byte b) {
            this.value = b;
        }
    }
    ...
    public enum POSITIONING_EXT_LIB_TYPE {
        ...
        private POSITIONING_EXT_LIB_TYPE(byte b) {
            this.value = b;
        }
    }
    ...
    public enum SLEEP_MONITOR_EXT_LIB_TYPE {
        ...
        private SLEEP_MONITOR_EXT_LIB_TYPE(byte b) {
            this.value = b;
        }
    }
