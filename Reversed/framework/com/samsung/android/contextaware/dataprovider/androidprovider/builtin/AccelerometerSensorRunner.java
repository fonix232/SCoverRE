...
public class AccelerometerSensorRunner extends RawSensorProvider {
    public AccelerometerSensorRunner(int i, Context context, Looper looper, ISensorHubResetObservable iSensorHubResetObservable) {
        this(i, context, looper, iSensorHubResetObservable, 60000);
    }

    public AccelerometerSensorRunner(int i, Context context, Looper looper, ISensorHubResetObservable iSensorHubResetObservable, int i2) {
