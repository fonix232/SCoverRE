...
public class MagneticSensorRunner extends RawSensorProvider {
    public MagneticSensorRunner(int i, Context context, Looper looper, ISensorHubResetObservable iSensorHubResetObservable) {
        this(i, context, looper, iSensorHubResetObservable, 60000);
    }

    public MagneticSensorRunner(int i, Context context, Looper looper, ISensorHubResetObservable iSensorHubResetObservable, int i2) {
