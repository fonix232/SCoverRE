...
public interface IOnUserChangedListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOnUserChangedListener {
        private static final String DESCRIPTOR = "com.samsung.android.content.clipboard.IOnUserChangedListener";
        ...
        public static IOnUserChangedListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IOnUserChangedListener)) ? new Proxy(iBinder) : (IOnUserChangedListener) queryLocalInterface;
        }
