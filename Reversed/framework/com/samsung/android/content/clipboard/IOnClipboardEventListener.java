...
public interface IOnClipboardEventListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOnClipboardEventListener {
        private static final String DESCRIPTOR = "com.samsung.android.content.clipboard.IOnClipboardEventListener";
        ...
        public static IOnClipboardEventListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IOnClipboardEventListener)) ? new Proxy(iBinder) : (IOnClipboardEventListener) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    onClipboardEvent(parcel.readInt(), parcel.readInt() != 0 ? (SemClipData) SemClipData.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 2:
                    parcel.enforceInterface(DESCRIPTOR);
                    onUpdateFilter(parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
