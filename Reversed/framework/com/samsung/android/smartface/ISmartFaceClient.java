...
public interface ISmartFaceClient extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISmartFaceClient {
        ...
        public static ISmartFaceClient asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ISmartFaceClient)) ? new Proxy(iBinder) : (ISmartFaceClient) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    onInfo(parcel.readInt(), parcel.readInt() != 0 ? (FaceInfo) FaceInfo.CREATOR.createFromParcel(parcel) : null, parcel.readInt());
                    return true;
                case 1598968902:
