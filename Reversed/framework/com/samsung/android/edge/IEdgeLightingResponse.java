...
public interface IEdgeLightingResponse extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IEdgeLightingResponse {
        private static final String DESCRIPTOR = "com.samsung.android.edge.IEdgeLightingResponse";
        ...
        public static IEdgeLightingResponse asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IEdgeLightingResponse)) ? new Proxy(iBinder) : (IEdgeLightingResponse) queryLocalInterface;
        }
