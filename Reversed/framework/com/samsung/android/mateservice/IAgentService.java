...
public interface IAgentService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAgentService {
        private static final String DESCRIPTOR = "com.samsung.android.mateservice.IAgentService";
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    Bundle executeAction = executeAction(parcel.readInt(), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    if (executeAction != null) {
                        parcel2.writeInt(1);
                        executeAction.writeToParcel(parcel2, 1);
                    } else {
                        parcel2.writeInt(0);
                    }
                    return true;
    ...
    Bundle executeAction(int i, Bundle bundle) throws RemoteException;
}
