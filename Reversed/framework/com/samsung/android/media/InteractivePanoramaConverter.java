...
import com.samsung.android.app.interactivepanoramaviewer.sharevia.InteractiveShotInfo;
...
public class InteractivePanoramaConverter {
    private static final /* synthetic */ int[] f15xbe7fc578 = null;
    static final int QUEUE_CAPAPCITY = 2;
    private static final String TAG = "InteractivePanoramaConverter";
    private static final int TARGET_BIT_RATE = 6000000;
    ...
    private static InteractivePanoramaConverter mInstance;
    boolean TWICE_ENCODING = true;
    ...
    private static /* synthetic */ int[] m11xba85ff54() {
        if (f15xbe7fc578 != null) {
            return f15xbe7fc578;
        }
    ...
    private InteractivePanoramaConverter() {
    }

    private void decodeMp4(InteractiveShotInfo interactiveShotInfo) {
        long currentTimeMillis;
        Throwable e;
        Log.v(TAG, "decodeMp4 entry");
        this.mDecodeTime = System.currentTimeMillis();
        DecoderInterfaceFHD decoderInterfaceFHD = new DecoderInterfaceFHD(interactiveShotInfo.mVideoPath);
        ...
        byte[][] bArr = interactiveShotInfo.getResize() ? (byte[][]) Array.newInstance(Byte.TYPE, new int[]{4, 1382400}) : (byte[][]) Array.newInstance(Byte.TYPE, new int[]{4, ((contentMetaData.mWidth * contentMetaData.mHeight) * 3) / 2});
        int i = 0;
        int i2 = 0;
        decoderInterfaceFHD.getClass();
        BufferData bufferData = new BufferData(decoderInterfaceFHD);
        Object obj = new byte[1];
        int i3 = interactiveShotInfo.mLastFrame;
        int i4 = 0;
        while (true) {
            int i5;
            try {
    ...
    private void encodeMp4(String str, InteractiveShotInfo interactiveShotInfo) {
        ...
        int i = 0;
        switch (m11xba85ff54()[this.mEncoder.ordinal()]) {
            case 1:
                encoderInterface = new EncoderInterface();
                i = encoderInterface.init(TARGET_ENCODE_WIDTH, TARGET_ENCODE_HEIGHT, TARGET_BIT_RATE, 30, 1, 21, file.getAbsolutePath(), interactiveShotInfo.mOrientation);
                break;
            case 2:
    ...
    public static synchronized InteractivePanoramaConverter getInstance() {
        InteractivePanoramaConverter interactivePanoramaConverter;
        synchronized (InteractivePanoramaConverter.class) {
            if (mInstance == null) {
                mInstance = new InteractivePanoramaConverter();
            }
            interactivePanoramaConverter = mInstance;
        }
        return interactivePanoramaConverter;
    }

    private void processFrame(InteractiveShotInfo interactiveShotInfo) {
        long currentTimeMillis;
        int i;
        int i2;
        Throwable e;
        ...
        OffscreenRenderer.offscreenInitialize(null, interactiveShotInfo.mWidth, interactiveShotInfo.mHeight, interactiveShotInfo.mCropX, interactiveShotInfo.mCropY, interactiveShotInfo.mCropWidth, interactiveShotInfo.mCropHeight, TARGET_ENCODE_WIDTH, TARGET_ENCODE_HEIGHT, 0, interactiveShotInfo.transformRotation(), false);
        ...
        while (!this.bStopRequested) {
            try {
                ...
                try {
                    ...
                    i2 = i3 + 1;
                    try {
                        OffscreenRenderer.offscreenTransformFrame(bArr2, obj2, interactiveShotInfo.mSRCMatrix[i3]);
    ...
    public synchronized void convertToMP4(String str, String str2) {
        ...
        synchronized (this.lock) {
            ...
            final InteractiveShotInfo instance = InteractiveShotInfo.getInstance();
            if (instance.init(str, str2)) {
                ...
                if (instance.mWidth * instance.mHeight >= 2073600) {
                    instance.getResizedValue(1920, GL10.GL_INVALID_ENUM);
                }
                ...
                this.mEncoderThread = new Thread(new Runnable() {
                    public void run() {
                        InteractivePanoramaConverter.this.encodeMp4(str3, instance);
                    }
                });
                this.mEncoderThread.start();
                this.mGLThread = new Thread(new Runnable() {
                    public void run() {
                        InteractivePanoramaConverter.this.processFrame(instance);
                    }
                });
                ...
                InteractiveShotInfo.freeInstance();
                if (instance.mOrientation == 90 || instance.mOrientation == 270) {
                    i = TARGET_ENCODE_WIDTH;
                    TARGET_ENCODE_WIDTH = TARGET_ENCODE_HEIGHT;
                    TARGET_ENCODE_HEIGHT = i;
