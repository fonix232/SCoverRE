...
public interface IPassChecker extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPassChecker {
        private static final String DESCRIPTOR = "com.samsung.android.pass.IPassChecker";
        ...
        public static IPassChecker asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPassChecker)) ? new Proxy(iBinder) : (IPassChecker) queryLocalInterface;
        }
