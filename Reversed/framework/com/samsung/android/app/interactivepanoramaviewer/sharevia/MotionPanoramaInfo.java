...
public class MotionPanoramaInfo implements AppController {
    private static final String SEF_KEYNAME_SOUND_SHOT_WAVE = "Motion_Panorama_AAC_000";
    static MotionPanoramaInfo mInstance;
    final String KEY_INFO = "Motion_Panorama_Info";
    final String KEY_VIDEO = "Motion_Panorama_MP4_000";
    final String TAG = "InteractivePano_InteractiveShotInfo";
    ...
    private MotionPanoramaInfo() {
    }

    public static synchronized void freeInstance() {
        synchronized (MotionPanoramaInfo.class) {
            mInstance = null;
        }
    }
    ...
    private boolean getInfo(String str) {
        Throwable th;
        try {
            byte[] data = SemExtendedFormat.getData(this.sefFile, "Motion_Panorama_Info");
            if (data != null) {
                ...
                if (this.mTotalFrames != 0 && (this.mLastFrame - this.mFirstFrame) + 1 > 0) {
                    ...
                    byte[] data2 = SemExtendedFormat.getData(this.sefFile, "Motion_Panorama_MP4_000");
                    if (data2 != null) {
                        ...
                        Log.m35v("InteractivePano_InteractiveShotInfo", "input video file path=  " + this.mVideoPath);
                        ...
                        Log.m33i("InteractivePano_InteractiveShotInfo", "SEF Data Null");
                        return false;
                    }
                }
                Log.m33i("InteractivePano_InteractiveShotInfo", "Total Frames is less than or equal to Zero ");
                return false;
            }
            Log.m33i("InteractivePano_InteractiveShotInfo", "SEF:getSEFData KEY_INFO returns null");
            return false;
        } catch (Throwable th4) {
            th4.printStackTrace();
            return false;
    ...
    public static synchronized MotionPanoramaInfo getInstance() {
        MotionPanoramaInfo motionPanoramaInfo;
        synchronized (MotionPanoramaInfo.class) {
            if (mInstance == null) {
                mInstance = new MotionPanoramaInfo();
            }
            motionPanoramaInfo = mInstance;
        }
        return motionPanoramaInfo;
    }
    ...
    public synchronized boolean init(java.lang.String r6, java.lang.String r7) {
        ...
        r3 = 0;
        monitor-enter(r5);
        r0 = "InteractivePano_InteractiveShotInfo";
        r1 = "motion pano sharevia version 1.0.2";
    ...
    L_0x0066:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.samsung.android.app.interactivepanoramaviewer.sharevia.MotionPanoramaInfo.init(java.lang.String, java.lang.String):boolean");
    }

    public void printInfo() {
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mWidth);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mHeight);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mTotalFrames);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mFirstFrame);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mLastFrame);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mAlgoType);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mAlgoVersion);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mOrientation);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mCaptureDirection);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mCameraType);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mCropX);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mCropY);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mCropWidth);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mCropHeight);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mMatrixWidth);
        Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + this.mMatrixHeight);
        int i = 0;
        while (this.mSRCMatrix != null && i < this.mSRCMatrix.length) {
            Log.m29d("InteractivePano_InteractiveShotInfo", "IP:: values: " + Arrays.toString(this.mSRCMatrix[i]));
            i++;
        }
    }
