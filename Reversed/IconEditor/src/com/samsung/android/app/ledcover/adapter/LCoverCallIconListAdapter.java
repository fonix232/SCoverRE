...
public class LCoverCallIconListAdapter extends BaseAdapter {
    ...
    /* renamed from: com.samsung.android.app.ledcover.adapter.LCoverCallIconListAdapter.1 */
    class C01991 implements OnClickListener {
        ...
        public void onClick(View v) {
            SLog.m12v(LCoverCallIconListAdapter.TAG, "[edit.setOnLongClick] position : " + this.val$position);
            LCoverCallIconListAdapter.this.mCallback.adapterEditClicked(this.val$position);
        }
    }
    ...
    static {
        TAG = "[LED_COVER]LCoverCallIconListAdapter";
    }

    public LCoverCallIconListAdapter(Context context, ArrayList<LCoverIconInfo> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (type == this.CUSTOM_TYPE) {
            ...
            holder.edit.setOnClickListener(new C01991(position));
        ...
        holder.count.setText(this.mContext.getString(C0198R.string.sview_led_cover_caller_id_count, new Object[]{NumberFormat.getInstance().format((long) getContactsCnt(position))}));
        return convertView;
    }
    ...
    public int getContactsCnt(int position) {
        return ((LCoverIconInfo) this.mLCoverIconInfo.get(position)).mCallerIDCount;
    }
